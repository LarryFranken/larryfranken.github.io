...
$(function() { 
	var all_ul =$(".list_list");
	/*一级列表*/
	$('.list_list li a').each(function(){
		var len =parseInt($(this).css("padding-left"));
		len= len+20;
		$(this).css("padding-left",""+len+"px");
	});
	/*二级列表*/
	$('.list_list li ul li a').each(function(){
		var len =parseInt($(this).css("padding-left"));
		len= len+30;
		$(this).css("padding-left",""+len+"px");
	});
	/*三级列表*/
	$('.list_list li ul li ul li a').each(function(){
		var len =parseInt($(this).css("padding-left"));
		len= len+30;
		$(this).css("padding-left",""+len+"px");
	});
	/*四级列表*/
	$('.list_list li ul li ul li ul li a').each(function(){
		var len =parseInt($(this).css("padding-left"));
		len= len+30;
		$(this).css("padding-left",""+len+"px");
	});
